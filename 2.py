...
def load_data():
    try:
        ...
        clustered_data = pd.read_csv("data/Clustered Data.csv")
        association_rules = pd.read_csv("data/Amazon Association rules.csv")
        return amazon_data, clustered_data, association_rules
    except FileNotFoundError as e:
        st.error("❌ Error: Data files not found. Please ensure all CSV files are in the 'data' folder.")
        st.stop()
